...
export const filterAffairs = (
  ...
  // need to fix any
  let newArray = affairs;
  if (filter === "high")
    newArray = affairs.filter((el) => el.priority === "high");
  if (filter === "low")
    newArray = affairs.filter((el) => el.priority === "low");
  if (filter === "middle")
    newArray = affairs.filter((el) => el.priority === "middle");

  return newArray; // need to fix
};
